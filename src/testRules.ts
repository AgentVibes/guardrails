...
const EXPECTATIONS: Expectation[] = [
  ...
  {
    rule: "ts-pattern-dangling-match",
    badSuffix: "ts-pattern-dangling-match/bad.ts",
    hits: 2,
    goodSuffix: "ts-pattern-dangling-match/good.ts",
  },
  {
    rule: "discriminator-ternary",
    badSuffix: "discriminator-ternary/bad.tsx",
    hits: 6,
    goodSuffix: "discriminator-ternary/good.tsx",
  },
  {
    rule: "literal-union-in-component",
    badSuffix: "literal-union-in-component/components/bad.ts",
    hits: 4,
    goodSuffix: "literal-union-in-component/components/good.ts",
  },
  {
    rule: "hardcoded-url-in-component",
    badSuffix: "hardcoded-url-in-component/components/bad.tsx",
    hits: 4,
    goodSuffix: "hardcoded-url-in-component/components/good.tsx",
  },
  ...
  {
    rule: "as-any-escape",
    badSuffix: "as-any-escape/bad.ts",
    hits: 4,
    goodSuffix: "as-any-escape/good.ts",
  },
  {
    rule: "catch-empty",
    badSuffix: "catch-empty/bad.ts",
    hits: 4,
    goodSuffix: "catch-empty/good.ts",
  },
  {
    rule: "instanceof-map-set",
    badSuffix: "instanceof-map-set/bad.ts",
    hits: 4,
    goodSuffix: "instanceof-map-set/good.ts",
  },
  {
    rule: "zod-optional-nullable",
    badSuffix: "zod-optional-nullable/bad.ts",
    hits: 6,
